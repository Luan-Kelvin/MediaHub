...
public class BookMenu {
    ...
    public void displayMenu(){
       ...
       while (resp != 0){
           ...
           System.out.println("[ 3 ] -> BAIXAR TODOS OS LIVROS DE UM AUTOR.");
           System.out.println("[ 4 ] -> BUSCAR LIVRO EXISTENTE.");
           System.out.println("[ 5 ] -> BUSCAR LIVRO POR TRECHO.");
           System.out.println("[ 6 ] -> BUSCAR LIVRO DE AUTOR.");
           System.out.println("[ 7 ] -> LISTAR LIVROS CADASTRADAS.");
           System.out.println("[ 8 ] -> LISTAR AUTORES CADASTRADOS.");
           System.out.println("[ 9 ] -> VER LIVRO COM MAIS EDIÇÕES.");
           System.out.println("[ 10 ] -> VER AUTOR COM MAIS EDIÇÕES.");
